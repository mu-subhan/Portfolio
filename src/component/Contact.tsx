...
import { 
  FiSend, FiCheckCircle, FiMail, FiPhone, FiMapPin, 
  FiLinkedin, FiGithub, FiClock, FiCalendar 
} from 'react-icons/fi';
...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 bg-gradient-to-br from-slate-50 via-white to-blue-50/20 relative">
      {/* Background Pattern */}
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          >
            Ready to build something amazing together? Let&apos;s discuss your project requirements, 
            technical challenges, or explore potential collaboration opportunities.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          <motion.div variants={itemVariants} className="lg:col-span-2 space-y-8">
            <div>
              <h3 className="text-2xl font-bold mb-4 text-slate-900">Let&apos;s Connect</h3>
              <p className="text-slate-600 leading-relaxed mb-8">
                I&apos;m passionate about creating innovative solutions and always excited to discuss
                new projects, whether it&apos;s a full-stack application, system architecture, or
            ...
            <div className="grid gap-4">
              {contactInfo.map((contact, index) => (
                <motion.div
                  key={index}
                  whileHover={{ y: -2 }}
                  className={`p-4 rounded-xl border ${contact.bgColor} hover:shadow-md transition-all duration-300`}
                >
            ...
            {/* Social Links */}
            <div className="pt-6">
              <p className="text-sm font-semibold text-slate-700 mb-4">Find me on</p>
              <div className="flex gap-3">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className={`p-4 bg-white border border-slate-200 rounded-xl transition-all duration-300 text-slate-600 ${social.color} shadow-sm hover:shadow-md`}
                  >
          ...
          <motion.div variants={itemVariants} className="lg:col-span-3">
            <div className="bg-white p-8 lg:p-10 rounded-2xl shadow-lg border border-slate-200">
              <div className="mb-8">
